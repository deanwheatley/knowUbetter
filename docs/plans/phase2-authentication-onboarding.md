...
- [ ] 1.1 Set up AWS Cognito user pools per organization
...
- [ ] 1.4 Implement SSO configuration per organization
...
- [ ] 1.5 Implement session management with organization context
...
### 2. Login & Signup UI
- [ ] 2.1 Create login page with SSO options
...
- [ ] 2.3 Create account type selection page
...
- [ ] 2.4 Create standard user signup form
...
- [ ] 2.5 Create organization admin signup flow (3 steps)
...
### 3. Invitation System
- [ ] 3.1 Implement email-based invitation detection
...
- [ ] 4.3 Apply organization branding settings
...
- [ ] 4.4 Initialize organization with defaults
...
### 5. Welcome Screens
- [ ] 5.1 Create welcome screen for users with teams
...
- [ ] 5.2 Create welcome screen for users without teams
